...
<body class="container-fluid">
	<div class="row base">
		...
		<script>ScrollReveal().reveal('.base',{delay:300});</script>
		<div class="row partone">
			...
			<div class="col-sm-8">
				<h2 class="title">Expérience de travail</h2>
				<ul>
					<li><p>L'art du pain : 2014-2015 / Saint-Gaudens</p>
						<p>Apprenti boulanger</p></li>
						<li><p>L'épi d'or : 2015 / Saint-Lary-Soulan</p>
							<p>Apprenti boulanger</p></li>
							<li><p>La boulangeoise : 2015-2016 / Saint-Gaudens</p>
								<p>Apprenti boulanger</p></li>
							</ul>
						</div>
					</div>
					...
					<div class="row parttwo">
						<div class="col-sm-4 darkest">
							<h2>Compétences</h2>
							<div class="restart">
								<p>Maîtriser des outils de développement</p>
								<p>Savoir modéliser des projets</p>
								<p>Utiliser des framework</p>
								<p>Repérer et corriger des problèmes sur un site</p>
							</div>
						</div>
						<div class="col-sm-8">
